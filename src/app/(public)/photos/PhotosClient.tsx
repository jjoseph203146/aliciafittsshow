  ...
  return (
    <>
      ...
      <section style={{ background: "#fff" }}>
        <div className="rsp-px" style={{ maxWidth: 1240, margin: "0 auto", padding: "34px 32px 6px", display: "flex", gap: 11, flexWrap: "wrap", justifyContent: "center" }}>
          {categories.map((cat) => (
      ...
      {/* ── Masonry Grid ── */}
      <section style={{ background: "#fff" }}>
        <div className="rsp-px" style={{ maxWidth: 1240, margin: "0 auto", padding: "34px 32px 80px" }}>
          <div className="rsp-masonry" style={{ columnCount: 3, columnGap: 22 }}>
            {visible.map((photo, i) => {
      ...
      {lbPhoto !== null && lightboxIndex !== null && (
        ...
        >
          <button
            ...
            style={{ position: "absolute", top: 16, right: 16, width: 52, height: 52, borderRadius: "50%", border: "1px solid rgba(255,255,255,0.3)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#fff", fontSize: 22, background: "rgba(0,0,0,0.3)" }}
          >✕</button>

          <button
            onClick={(e) => { e.stopPropagation(); navLightbox(-1); }}
            style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", width: 50, height: 50, borderRadius: "50%", border: "1px solid rgba(255,255,255,0.3)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#fff", fontSize: 26, background: "rgba(0,0,0,0.3)" }}
          >‹</button>

          <div onClick={(e) => e.stopPropagation()} style={{ width: "min(760px,88vw)", borderRadius: 14 }}>
            {lbPhoto.image_url ? (
          ...
          <button
            onClick={(e) => { e.stopPropagation(); navLightbox(1); }}
            style={{ position: "absolute", right: 14, top: "50%", transform: "translateY(-50%)", width: 50, height: 50, borderRadius: "50%", border: "1px solid rgba(255,255,255,0.3)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#fff", fontSize: 26, background: "rgba(0,0,0,0.3)" }}
          >›</button>

          <div style={{ position: "absolute", bottom: 20, left: "50%", transform: "translateX(-50%)", fontFamily: "ui-monospace,monospace", fontSize: 13, color: "rgba(255,255,255,0.75)", background: "rgba(0,0,0,0.35)", borderRadius: 999, padding: "6px 16px" }}>
