    ...
    <>
      ...
      <section style={{ background: "#F7F2FB" }}>
        <div className="rsp-px rsp-py" style={{ maxWidth: 1240, margin: "0 auto", padding: "64px 32px" }}>
          ...
          <h1 className="rsp-h1-md" style={{ fontFamily: PF, fontWeight: 800, fontSize: 54, color: "#4A2A6B", margin: "0 0 12px", letterSpacing: "-0.01em" }}>Be on the Show</h1>
      ...
      <section style={{ background: "#fff" }}>
        <div className="rsp-2col rsp-px rsp-py" style={{ maxWidth: 1240, margin: "0 auto", padding: "76px 32px", display: "grid", gridTemplateColumns: "1.05fr 0.95fr", gap: 54, alignItems: "center" }}>
          <div>
            <h2 className="rsp-h2-md" style={{ fontFamily: PF, fontWeight: 800, fontSize: 36, color: "#4A2A6B", margin: "0 0 18px" }}>Share Your Story</h2>
          ...
          <div className="rsp-hide" style={{ borderRadius: 20, overflow: "hidden", boxShadow: "0 24px 56px rgba(74,42,107,0.18)", aspectRatio: "4/3", background: "linear-gradient(150deg,#6B3F8F,#3A2456)" }} />
        </div>
      </section>

      {/* ── Form ── */}
      <section style={{ background: "#F7F2FB" }}>
        <div className="rsp-px" style={{ maxWidth: 760, margin: "0 auto", padding: "70px 32px" }}>
          <BeOnTheShowForms />
        </div>
      </section>
      ...
      {/* ── What Happens Next ── */}
      <section style={{ background: "#fff" }}>
        <div className="rsp-px rsp-py" style={{ maxWidth: 1000, margin: "0 auto", padding: "76px 32px" }}>
          <h2 className="rsp-h2-sm" style={{ fontFamily: PF, fontWeight: 800, fontSize: 36, color: "#4A2A6B", margin: "0 0 48px", textAlign: "center" }}>What Happens Next</h2>
          <div className="rsp-steps" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 30, position: "relative" }}>
            <div className="rsp-steps-line" style={{ position: "absolute", top: 26, left: "16%", right: "16%", height: 2, background: "linear-gradient(90deg,#E91E8C,#F8A5C8)" }} />
            {steps.map((st) => (
      ...
      {/* ── Testimonials ── */}
      <section style={{ background: "#F7F2FB" }}>
        <div className="rsp-2col rsp-px rsp-py" style={{ maxWidth: 1000, margin: "0 auto", padding: "70px 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 26 }}>
          {testimonials.map((t) => (
